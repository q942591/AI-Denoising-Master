...
export interface DashscopeTaskQueryOutput {
  /**
   * 请求失败的错误码。请求成功时不会返回此参数
   */
  code?: string;
 ...
 * 表情包视频生成API请求参数
 */
export interface EmojiVideoRequest {
  /**
   * 输入参数
   */
  input: {
 ...
 * 表情包视频生成任务提交响应
 */
export interface EmojiVideoResponse {
  /**
   * 输出结果
   */
  output: {
 ...
 * 表情包视频任务查询结果
 */
export interface EmojiVideoTaskResult {
  /**
   * 输出信息
   */
  output: {
 ...
 */
export interface LivePortraitDetectRequest {
  /**
   * 输入参数
   */
  input: {
 ...
 */
export interface LivePortraitDetectResponse {
  /**
   * 输出结果
   */
  output: {
 ...
 */
export interface LivePortraitTaskResult {
  /**
   * 输出信息
   */
  output: {
 ...
 * LivePortrait动作模板类型
 */
export type LivePortraitTemplateId = 'active' | 'calm' | 'normal';
 ...
 */
export interface VideoRetalkRequest {
  /**
   * 输入参数
   */
  input: {
 ...
 */
export interface VideoRetalkResponse {
  /**
   * 输出结果
   */
  output: {
 ...
 * VideoRetalk任务查询结果
 */
export interface VideoRetalkTaskResult {
  /**
   * 输出信息
   */
  output: {
